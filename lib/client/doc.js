...
Doc.prototype._handlePendingSubscribe = function() {
  if (this.wantSubscribe.length) {
    var ws = this.wantSubscribe.shift();
...
Doc.prototype._setWantSubscribe = function(value, callback, err) {
  ...
  if (callback) this._subscribeCallbacks[value].push(callback);
  this.connection.flush(this);
};
...
Doc.prototype.subscribe = function(callback) {
  this._setWantSubscribe('subscribe', callback);
};

// Unsubscribe. The data will stay around in local memory, but we'll stop
// receiving updates.
Doc.prototype.unsubscribe = function(callback) {
  this._setWantSubscribe('unsubscribe', callback);
};
